// ─────────────────────────────────────────────────────────────────────────────
// api/utils/formatTime.js — Server-Side Timezone Utility (Vercel Serverless)
//
// ESM version for Vercel Serverless Functions.
// Mirrors netlify/functions/utils/formatTime.cjs functionality.
// ─────────────────────────────────────────────────────────────────────────────
 ...
 * @returns {string}
 */
export function formatTime(timestamp, timezone, options = {}) {
  const {
    locale = 'en-IN',
    preset = 'default',
